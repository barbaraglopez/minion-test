...
export const BurguerNav = () => {
  ...
  return (
    <div className="flex items-center justify-between border-b border-gray-400 py-8 hidden max-lg:block max-lg:flex max-lg:justify-between p-5 w-screen containerNav">
      <div>
        <img src="../../../img/Icono_minion_app.svg" className="h-7 ml-3" />
      </div>
      <nav>
        <section className="MOBILE-MENU flex lg:hidden items-center">
          <img src="../../../img/Profile.svg" className="h-8 ml-4" />
          <div
          ...
          <div
            className={
              isNavOpen ? "menu-container showMenuNav" : "menu-container"
            }
          >
            <div
            ...
            <ul className="flex flex-col items-center justify-between min-h-[250px]">
              {Menus.map((menu, index) => (
                ...
                >
                  <div className="">
                    <img src={menu.icon} className="ml-4 mr-2 icon" />
                  </div>
