          ...
          <div>
            <div className="w-full flex-col h-30 flex p-10 max-md:p-3 bg-slate-50 rounded-xl h-full font-semibold">
              <div className="flex justify-between p-3 items-center max-lg:flex-col max-lg:h-16">
                <img src="../../../img/Nuevo_prompt.svg" className="h-5 max-lg:mb-2" />
              ...
              <div className="flex justify-end max-lg:justify-center">
                <button onClick={() => handleEditarPrompt()} className="boton-large boton-primario rounded-lg p-2 text-slate-100 w-52 max-lg:w-40">
                  Guardar cambios
                </button>
              </div>
            </div>
