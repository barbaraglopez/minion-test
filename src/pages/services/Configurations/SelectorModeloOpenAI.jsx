...
export const SelectorModeloOpenAI = () => {
    ...
    const handleChangeSelect = (event) => {
      ...
      const sendData = () => {
            axios.post(`${BASE_URL}/config`, { key:"OPENAI_MODEL", value:opcionSeleccionada })
                .then(response => {
                    (response)
                    let obj = {
                        icono: "../../../../../img/Modal_icono_ok.svg",
            ...
            <div className="containerLabelInput mb-3">
                ...
                <div className="containerLabelInput">
                    <div className="relative h-10  min-w-[200px] inputContainer">
                        <select id="opciones" value={opcionSeleccionada} onChange={handleChangeSelect} className="peer h-full w-full rounded-[7px] border border-blue-gray-200 border-t-transparent bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 empty:!bg-gray-900 focus:border-2 focus:border-gray-900 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50 bg-white">
                        ...
                        <button onClick={() => sendData()} className="boton-primario w-64 text-sm p-2 mt-4 rounded-md font-semibold">
                            Actualizar modelo
                        </button>
